# NOTE(elsuizo:2019-07-23): this file is part of Julia language: https://github.com/JuliaLang/julia/blob/master/stdlib/LinearAlgebra/src/dense.jl#L530-L611
...
function exp!(A::StridedMatrix{T}) where T<:BlasFloat
    ...
    # NOTE(elsuizo:2019-07-23): `gebal`: Balances a general matrix to improve the accuracy of computed eigenvalues and eigenvectors.
